...
export default function TopNavigation() {
  ...
  return (
    <nav className="max-w-screen-xl">
      <div
        className={clsx(
          'fixed mt-2 rounded-md overflow-hidden bottom-0 top-0 right-0 left-0 z-20 bg-gray-300/70 transition duration-300',
      ...
      >
        <div className="bg-white h-screen w-full flex flex-col items-center">
          ...
          <button
            ...
            className=" flex bg-gray-300 h-1 w-1/12"
          />
          {/* address config  */}
          ...
          <div className="w-full p-4 flex">
            ...
            <input
              type="text"
              className="w-full bg-gray-300 px-2 py-1 placeholder:text-sm placeholder:px-2 rounded-r-md outline-none"
          ...
          <div className="flex   w-full justify-between">
            <div className="flex items-center ml-4 gap-2">
              ...
              <p className="text-sm">현재위치로 설정 </p>
            </div>
            <div className="mr-4">
              <span>
                <svg
          ...
          <div className="h-2 my-4 w-full bg-gray-300" />
          <div className="w-full flex">우리집 추가</div>
          <div className="h-2 my-4 w-full bg-gray-300" />
      ...
      <div className="flex flex-col w-full  justify-center items-center border rounded-b-xl bg-blue-400">
        <div className="flex justify-between w-full mt-5 p-2">
          ...
          <div className="flex ">
            <p className="text-white font-semibold truncate max-w-60">
              경기도 고양시 엘팩토리 42-4 신풍플로스타
            </p>
            <button className="text-white" onClick={() => setDialog(true)}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div className="flex w-full p-2">
          <span className="flex w-1/7 justify-center items-center bg-white rounded-l-sm pl-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <input
            className="  w-full rounded-sm p-2 mr-8   outline-none"
            placeholder="hi "
          />
        </div>
      </div>
